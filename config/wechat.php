...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx79d25f2ba34e4bd0'),         // AppID
    'secret'  => env('WECHAT_SECRET', '2c902f0410d0fe1089419a4ed3f17705'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'planet'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'IgwkzpQUecaZo1X5IgCeRHxuhAzDNXWdTT5UvfPQciT'),                    // EncodingAESKey
